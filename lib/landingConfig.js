export const landingConfig = {
  ...
  features: [
    {
      ...
      description:
        "Intuitive interface that lets you build pages by simply dragging and dropping elements.",
    ...
    },
    {
      ...
      description:
        "All pages are automatically optimized for mobile, tablet, and desktop devices.",
      icon: "/placeholder.svg?height=48&width=48",
      image: "/placeholder.svg?height=300&width=400",
    },
  ],
  ...
  footer: {
    ...
    description:
      "The easiest way to create professional landing pages that convert visitors into customers.",
    headings: {
      product: "Product",
      company: "Company",
      support: "Support",
